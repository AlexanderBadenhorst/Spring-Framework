...
public class JdbcOrderRepository implements OrderRepository {
    ...
    public TacoOrder save(TacoOrder order) {
        ...
        Number orderKey = keyHolder.getKey();
        long orderId = (orderKey != null) ? orderKey.longValue() : -1L;
        order.setId(orderId);
    ...
    private long saveTaco(Long orderId, int orderKey, Taco taco) {
        ...
        long tacoId = (tacoKey != null) ? tacoKey.longValue() : -1L;
        taco.setId(tacoId);
