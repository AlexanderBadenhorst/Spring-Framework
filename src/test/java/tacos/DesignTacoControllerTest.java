...
import tacos.chap3.IngredientRef;
import tacos.chap3.Taco;
import tacos.chap3.data.IngredientRepository;
import tacos.chap3.web.DesignTacoController;
import tacos.chap3.web.IngredientByIdConverter;

@ExtendWith(SpringExtension.class)
@WebMvcTest(controllers = DesignTacoController.class)
@Import(IngredientByIdConverter.class) // needed for String -> Ingredient binding
public class DesignTacoControllerTest {
    ...
    public void processTaco() throws Exception {
        mockMvc.perform(post("/design")
                        ...
                        // use repeated parameters for list binding
